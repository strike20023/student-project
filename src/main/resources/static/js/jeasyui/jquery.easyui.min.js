...
(function ($) {
    ...
    $.fn.pagination.defaults = {
        total: 1, pageSize: 10, pageNumber: 1, pageList: [5, 10, 20, 30, 50], loading: false, buttons: null, showPageList: true, showRefresh: true, links: 10, layout: ["list", "sep", "first", "prev", "sep", "manual", "sep", "next", "last", "sep", "refresh"], onSelectPage: function (_c7, _c8) {
...
(function ($) {
    ...
    $.fn.tree.defaults = {
        url: null, method: "post", animate: false, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, dnd: false, data: null, queryParams: {}, formatter: function (node) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, timeout: 0, data: _1c9, dataType: "json", success: function (data) {
                    _1ca(data);
                }, error: function () {
...
(function ($) {
    ...
    $.messager = {
        show: function (_2b1) {
            ...
            var dlg = _2ad($.extend({}, $.messager.defaults, { content: "<div class=\"messager-progress\"><div class=\"messager-p-msg\">" + opts.msg + "</div><div class=\"messager-p-bar\"></div></div>", closable: false, doSize: false }, opts, {
                onClose: function () {
                    if (this.timer) {
...
(function ($) {
    ...
    function _2da(_2db, pp, _2dc) {
        ...
        pp.panel($.extend({}, { collapsible: true, minimizable: false, maximizable: false, closable: false, doSize: false, collapsed: true, headerCls: "accordion-header", bodyCls: "accordion-body" }, _2dc, {
            onBeforeExpand: function () {
    ...
    $.fn.accordion.defaults = {
        width: "auto", height: "auto", fit: false, border: true, animate: true, multiple: false, selected: 0, onSelect: function (_308, _309) {
...
(function ($) {
    ...
    function _340(_341, _342, pp) {
        ...
        pp.panel($.extend({}, _342, {
            tab: tab, border: false, noheader: true, closed: true, doSize: false, iconCls: (_342.icon ? _342.icon : undefined), onLoad: function () {
                if (_342.onLoad) {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 27, selected: 0, showHeader: true, plain: false, fit: false, border: true, justified: false, narrow: false, pill: false, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_389) {
...
(function ($) {
    ...
    function _3ba(_3bb, _3bc, _3bd) {
        ...
        function _3c1(dir) {
            ...
            p.panel($.extend({}, $.fn.layout.paneldefaults, {
                cls: ("layout-expand layout-expand-" + dir), title: "&nbsp;", iconCls: (_3bf.hideCollapsedContent ? null : _3bf.iconCls), closed: true, minWidth: 0, minHeight: 0, doSize: false, region: _3bf.region, collapsedSize: _3bf.collapsedSize, noheader: (!isns && _3bf.hideExpandTool), tools: ((isns && _3bf.hideExpandTool) ? null : [{
    ...
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, {
        region: null, split: false, collapsedSize: 28, expandMode: "float", hideExpandTool: false, hideCollapsedContent: true, collapsedContent: function (_3f2) {
            var p = $(this);
...
(function ($) {
    ...
    $.fn.switchbutton.defaults = {
        handleWidth: "auto", width: 60, height: 26, checked: false, disabled: false, readonly: false, reversed: false, onText: "ON", offText: "OFF", handleText: "", value: "on", onChange: function (_480) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    $.fn.textbox.defaults = $.extend({}, $.fn.validatebox.defaults, {
        width: "auto", height: 22, prompt: "", value: "", type: "text", timeout: 0, multiline: false, editable: true, disabled: false, readonly: false, icons: [], iconCls: null, iconAlign: "right", iconWidth: 18, buttonText: "", buttonIcon: null, buttonAlign: "right", inputEvents: {
            blur: function (e) {
                var t = $(e.data.target);
...
(function ($) {
    ...
    function load(_523, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _524, dataType: "json", async: false, success: function (data) {
                    _525(data);
                }, error: function () {
    ...
    $.fn.form.defaults = {
        fieldTypes: ["combobox", "combotree", "combogrid", "datetimebox", "datebox", "combo", "datetimespinner", "timespinner", "numberspinner", "spinner", "slider", "searchbox", "numberbox", "textbox", "switchbutton"], novalidate: false, ajax: true, url: null, timeout: 0, queryParams: {}, onSubmit: function (_543) {
...
(function ($) {
    ...
    function _614(_615) {
        ...
        if (opts.pagination) {
            ...
            _61c.pagination({
                total: (opts.pageNumber * opts.pageSize), pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_61d, _61e) {
    ...
    function _629(_62a) {
        ...
        _62e.each(function () {
            $(this).resizable({
                handles: _631, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _62b.resizing = true;
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [5, 10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, rowEvents: { mouseover: _635(true), mouseout: _635(false), click: _63d, dblclick: _647, contextmenu: _64b }, rowStyler: function (_7d9, _7da) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, timeout: 0, data: _7db, dataType: "json", cache: false, async: true, success: function (data) {
                    _7dc(data);
                }, error: function () {
...
(function ($) {
    ...
    function _815(_816) {
        ...
        $(_816).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_818, row) {
...
(function ($) {
    function _862(_863) {
        ...
        if (opts.pagination) {
            ...
            _86f.pagination({
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_870, _871) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, lines: false, animate: false, singleSelect: true, view: _8ec, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _87d(true), mouseout: _87d(false), click: _87f }), loader: function (_929, _92a, _92b) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, timeout: 0, data: _929, dataType: "json", success: function (data) {
                    _92a(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _939, textFormatter: function (_955, row) {
            return _955;
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _968, keydown: _96c, paste: _96c, drop: _96c }, panelWidth: null, panelHeight: 200, panelMinWidth: null, panelMaxWidth: null, panelMinHeight: null, panelMaxHeight: null, panelAlign: "left", multiple: false, selectOnNavigation: true, separator: ",", hasDownArrow: true, delay: 200, keyHandler: {
            up: function (e) {
            }, down: function (e) {
            }, left: function (e) {
            }, right: function (e) {
                    ...
                    for (var j = 0; j < _values.length; j++)
                    {
                        for (var i = 0; i < _data.length; i++) {
                            if (_data[i][_options.valueField] == _values[j]) {
                                _newvalues.push(_values[j]);
                            }
                        }
                    }
                    if (_newvalues.length > 0) {
                        $(this).combobox('setValues', _newvalues);
                    }
                    else {
                        $(this).combobox('clear');
                    }
...
(function ($) {
    ...
    function _9ac(_9b2, _9b3, _9b4) {
        if ($.data(_9b2, "combobox") != undefined) {
    ...
    $.fn.combobox.methods = {
        options: function (jq) {
            ...
            if ($.data(jq[0], "combobox") != undefined) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupField: null, groupFormatter: function (_9de) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, timeout: 0, data: _9df, dataType: "json", success: function (data) {
                    _9e0(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_ac4) {
            return _ac4;
        }, converter: {
